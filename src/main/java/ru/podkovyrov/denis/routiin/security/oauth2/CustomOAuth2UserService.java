package ru.podkovyrov.denis.routiin.security.oauth2;
...
import ru.podkovyrov.denis.routiin.security.oauth2.user.OAuth2UserInfo;
import ru.podkovyrov.denis.routiin.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setScore(0L);
        user.setLogin("id" + userRepository.save(user).getId());
